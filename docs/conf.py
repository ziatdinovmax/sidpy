...
author = (
    "Suhas Somnath, Gerd Duscher, Rama K. Vasudevan, Raj Giridhar, and contributors"
)
...
man_pages = [(master_doc, "pynsid", "pyNSID Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "pyNSID",
        "Framework for storing, visualizing, and processing "
...
from sphinx_gallery.sorting import (
    ExampleTitleSortKey,
    ExplicitOrder,
)  # Can't use until next release of sphinx-gallery
